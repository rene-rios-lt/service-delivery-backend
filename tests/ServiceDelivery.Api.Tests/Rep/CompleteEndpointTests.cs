...
public class CompleteEndpointTests
{
    private static async Task<Guid> SeedCompletionScenarioAsync(
    ...
    [Fact]
    public async Task GivenAnOnSiteRepWithInProgressRequest_WhenCompletePosted_ThenReturns200WithCompletedResult()
    {
        // Arrange
        ...
        // Act
        var response = await client.PostAsync("/rep/complete", null);
        ...
        result.RequestStatus.Should().Be("Completed");
    }

    [Fact]
    public async Task GivenARepWithNoActiveRequest_WhenCompletePosted_ThenReturns400()
    {
        // Arrange
        await using var factory = new CustomWebApplicationFactory();
        var client = await AuthedClientAsync(factory, "rep1@dealer.com");
    ...
    [Fact]
    public async Task GivenARepNotOnSite_WhenCompletePosted_ThenReturns400()
    {
        // Arrange
        await using var factory = new CustomWebApplicationFactory();
        await SeedCompletionScenarioAsync(factory, SeedConstants.Rep1Id, repState: RepState.EnRoute);
        var client = await AuthedClientAsync(factory, "rep1@dealer.com");
    ...
    [Fact]
    public async Task GivenADispatcherToken_WhenCompletePosted_ThenReturns403()
    {
        // Arrange
        await using var factory = new CustomWebApplicationFactory();
    ...
    [Fact]
    public async Task GivenARequesterToken_WhenCompletePosted_ThenReturns403()
    {
        // Arrange
        await using var factory = new CustomWebApplicationFactory();
    ...
    [Fact]
    public async Task GivenNoAuthorizationHeader_WhenCompletePosted_ThenReturns401()
    {
        // Arrange
        await using var factory = new CustomWebApplicationFactory();
        var client = factory.CreateClient();
